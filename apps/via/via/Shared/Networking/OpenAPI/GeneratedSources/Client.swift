...
internal struct Client: APIProtocol {
    ...
    internal func notifications_period_registerActivity(_ input: Operations.notifications_period_registerActivity.Input) async throws -> Operations.notifications_period_registerActivity.Output {
        try await client.send(
            input: input,
            forOperation: Operations.notifications_period_registerActivity.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/notifications/live-activity",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.notifications_period_registerActivity.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Operations.notifications_period_registerActivity.Output.Ok.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    internal func notifications_period_unregisterActivity(_ input: Operations.notifications_period_unregisterActivity.Input) async throws -> Operations.notifications_period_unregisterActivity.Output {
        try await client.send(
            input: input,
            forOperation: Operations.notifications_period_unregisterActivity.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/notifications/live-activity/unregister",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.notifications_period_unregisterActivity.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Operations.notifications_period_unregisterActivity.Output.Ok.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    internal func notifications_period_registerPushToStart(_ input: Operations.notifications_period_registerPushToStart.Input) async throws -> Operations.notifications_period_registerPushToStart.Output {
        try await client.send(
            input: input,
            forOperation: Operations.notifications_period_registerPushToStart.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/notifications/live-activity/push-to-start",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.notifications_period_registerPushToStart.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Operations.notifications_period_registerPushToStart.Output.Ok.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
