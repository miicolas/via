...
import { flowReducer, INITIAL_HOME_FLOW } from '@/features/map/model/flow';
...
import type { SelectedPlace } from '@/features/map/model/types';
...
import { journeyRequestKey, type JourneyRequest } from '@/features/journey/model/state';
...
export function MapProvider({ children }: PropsWithChildren) {
  ...
  const [flow, dispatchFlow] = useReducer(flowReducer, INITIAL_HOME_FLOW);
